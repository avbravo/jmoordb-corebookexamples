...
public interface AnimalRepository extends CrudRepository<Animal,Long>{
      @Find
    public Stream<Animal> findByColorAndApellidoAndEdadLessThanEquals(String color, String apellido, Integer edad);
    ...
    public List<Animal> queryByFecha(@IncludeTime Date fechaalimentacion);
        ...
        @Find
    public List<Animal> findByIEdadGreaterThanPagination(Long edad,Pagination pagination);
